...
func TestRenderSchema_BasicOutput(t *testing.T) {
	...
	checks := []struct {
		...
		{`aria-controls="properties"`, "schema search controls property results"},
		...
		{"<div class=\"search-status\" id=\"search-status\" data-empty-message=\"Tip: use .spec.replicas for path-only search\" role=\"status\" aria-live=\"polite\" aria-atomic=\"true\"></div>", "path search hint is deferred until JavaScript can check learned state"},
